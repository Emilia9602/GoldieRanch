        ...
        <div className="min-h-screen flex items-center justify-center bg-[#FAF6EE] text-[#342D26] px-6">
            ...
            <div className="text-center max-w-lg w-full">
                ...
                <p className="text-sm leading-relaxed mb-4">
                    ...
                    Tack för ert tålamod — vi ser fram emot att snart få dela den mer er.
                </p>

                <p className="text-sm text-[#6F5D48] mb-6 leading-relaxed">
                    Har du frågor eller vill göra en beställning redan nu?
                ...
                <div className="space-y-3 text-sm text-[#8C6843] mb-6">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <a
                            href="mailto:goldieranch96@gmail.com"
                            className="hover:underline font-medium"
                        >
                            goldieranch96@gmail.com
                        </a>
                    </div>

                    <p>
                        eller skicka meddelande på{" "}
                        <a
                ...
                <div className="flex justify-center items-center gap-6 text-[#8C6843]">
                    ...
                    <a
                        ...
                        target="_blank"
                        className="flex items-center gap-2 transition duration-300 hover:text-[#6F4E2E] hover:-translate-y-0.5 hover:scale-105"
                    >
                    ...
                    >
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                            <path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.43 23.1 10.23 24v-8.44H7.08v-3.49h3.15V9.41c0-3.1 1.84-4.82 4.66-4.82 1.35 0 2.76.24 2.76.24v3.04h-1.55c-1.53 0-2.01.96-2.01 1.94v2.33h3.42l-.55 3.49h-2.87V24C19.57 23.1 24 18.1 24 12.07z" />
                        </svg>
                        <span>Facebook</span>
                    </a>
